/*
Необходимо написать консольное C# приложение, принимающее имя файла и набор параметров.
В зависимости от параметров приложение должно работать в нескольких режимах:
...
2. Run -f filename -m checksum
    Разбивает содержимое файла на 32-битные "машинные слова" и выводит их сумму.
    В случае нехватки байт для последнего слова, считать их равными нулю.
3. Run -h
